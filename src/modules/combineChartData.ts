...
import { ChorusMapStringToDifficultyFlags, GetInstrumentFlagsFromChart, GetInstrumentFlagsFromChartByDiff, parseBoolOrDefault, parseIntOrDefault, parseIntOrNull } from './helpers'
...
export function combineChartData (iniData: ChorusIni, chartData: ChorusChart): charts {
  ...
  data.ini_five_lane_drums = parseBoolOrDefault(iniData.five_lane_drums, false)
  ...
  data.ini_modchart = parseBoolOrDefault(iniData.modchart, false)
  ...
  data.ini_pro_drums = parseBoolOrDefault(iniData.pro_drums, false)
